...
\NormalTok{water_results <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"EPIB607_FALL2018_water_exercise - water.csv"}\NormalTok{, }\DataTypeTok{as.is=}\OtherTok{TRUE}\NormalTok{)}
...
\NormalTok{m.melt <-}\StringTok{ }\NormalTok{water_results }\OperatorTok{%>%}\StringTok{ }\NormalTok{tidyr}\OperatorTok{::}\KeywordTok{gather}\NormalTok{(}\DataTypeTok{key =} \StringTok{"type"}\NormalTok{, }\DataTypeTok{value =} \StringTok{"value"}\NormalTok{, }\OperatorTok{-}\NormalTok{ID, }\OperatorTok{-}\NormalTok{student)}
