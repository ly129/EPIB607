...
\begin{longtable}[]{@{}ll@{}}
\toprule
Assignments & 10\%\tabularnewline
Quizzes & 40\%\tabularnewline
Final Exam & 50\%\tabularnewline
\bottomrule
\end{longtable}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{install.packages}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\StringTok{"pacman"}\NormalTok{, }\StringTok{"knitr"}\NormalTok{, }\StringTok{"data.table"}\NormalTok{, }
    \StringTok{"rmarkdown"}\NormalTok{, }\StringTok{"tidyverse"}\NormalTok{, }\StringTok{"boot"}\NormalTok{, }\StringTok{"Hmisc"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\addcontentsline{toc}{chapter}{(PART) Part I}
...
\begin{longtable}[]{@{}ll@{}}
\toprule
data type & description\tabularnewline
\midrule
\endhead
univariate & consists of observations on a single
variable\tabularnewline
bivariate & observations are made on each of two
variables\tabularnewline
multivariate & more than two variables\tabularnewline
\bottomrule
\end{longtable}
...
\BeginKnitrBlock{example}\iffalse{-91-84-119-111-32-110-117-99-108-101-111-116-105-100-101-32-115-101-113-117-101-110-99-101-115-93-}\fi{}

\protect\hypertarget{exm:unnamed-chunk-10}{}{(\#exm:unnamed-chunk-10)
...
\BeginKnitrBlock{definition}\iffalse{-91-83-97-109-112-108-101-32-83-112-97-99-101-93-}\fi{}

\protect\hypertarget{def:unnamed-chunk-11}{}{(\#def:unnamed-chunk-11)
...
\BeginKnitrBlock{example}\iffalse{-91-67-111-105-110-32-116-111-115-115-105-110-103-93-}\fi{}

\protect\hypertarget{exm:unnamed-chunk-12}{}{(\#exm:unnamed-chunk-12)
\iffalse (Coin tossing) \fi{}
}\(\Omega = \left\lbrace H, T \right\rbrace\)

\EndKnitrBlock{example}

\BeginKnitrBlock{example}\iffalse{-91-68-105-99-101-93-}\fi{}

\protect\hypertarget{exm:unnamed-chunk-13}{}{(\#exm:unnamed-chunk-13)
\iffalse (Dice) \fi{}
}\(\Omega = \left\lbrace 1,2,3,4,5,6 \right\rbrace\)

\EndKnitrBlock{example}

\BeginKnitrBlock{example}\iffalse{-91-80-114-111-112-111-114-116-105-111-110-115-93-}\fi{}

\protect\hypertarget{exm:unnamed-chunk-14}{}{(\#exm:unnamed-chunk-14)
\iffalse (Proportions) \fi{}
}\(\Omega = \left\lbrace x : 0 \leq x \leq 1 \right\rbrace\)

\EndKnitrBlock{example}

\BeginKnitrBlock{example}\iffalse{-91-84-105-109-101-32-109-101-97-115-117-114-101-109-101-110-116-93-}\fi{}

\protect\hypertarget{exm:unnamed-chunk-15}{}{(\#exm:unnamed-chunk-15)
\iffalse (Time measurement) \fi{}
}\(\Omega = \left\lbrace x : x > 0 \right\rbrace = {\mathbb{R}}^{+}\)

\EndKnitrBlock{example}

\BeginKnitrBlock{example}\iffalse{-91-84-101-109-112-101-114-97-116-117-114-101-32-109-101-97-115-117-114-101-109-101-110-116-93-}\fi{}

\protect\hypertarget{exm:unnamed-chunk-16}{}{(\#exm:unnamed-chunk-16)
\iffalse (Temperature measurement) \fi{}
}\(\Omega = \left\{ x:a\leq x\leq b\right\} \subseteq { \mathbb{R}}\)

\EndKnitrBlock{example}

\BeginKnitrBlock{example}\iffalse{-91-66-105-111-108-111-103-105-99-97-108-32-83-101-113-117-101-110-99-101-32-65-110-97-108-121-115-105-115-93-}\fi{}

\protect\hypertarget{exm:unnamed-chunk-17}{}{(\#exm:unnamed-chunk-17)
...
\BeginKnitrBlock{definition}\iffalse{-91-69-118-101-110-116-93-}\fi{}

\protect\hypertarget{def:unnamed-chunk-18}{}{(\#def:unnamed-chunk-18)
...
\BeginKnitrBlock{definition}\iffalse{-91-65-120-105-111-109-115-32-40-98-97-115-105-99-32-112-114-111-112-101-114-116-105-101-115-41-32-111-102-32-80-114-111-98-97-98-105-108-105-116-121-93-}\fi{}

\protect\hypertarget{def:unnamed-chunk-20}{}{(\#def:unnamed-chunk-20)
...
\protect\hypertarget{prp:unnamed-chunk-21}{}{(\#prp:unnamed-chunk-21)
...
\protect\hypertarget{prp:unnamed-chunk-22}{}{(\#prp:unnamed-chunk-22)
}For any event \(A\),\\
\[ P(A) = 1 - P(A^c) \]
...
\protect\hypertarget{prp:unnamed-chunk-23}{}{(\#prp:unnamed-chunk-23)
}For any event \(A\),\\
\[ P(A) \leq 1 \]
...
\protect\hypertarget{prp:unnamed-chunk-24}{}{(\#prp:unnamed-chunk-24)
...
\BeginKnitrBlock{proposition}\iffalse{-91-80-114-111-100-117-99-116-32-114-117-108-101-32-102-111-114-32-111-114-100-101-114-101-100-32-112-97-105-114-115-93-}\fi{}

\protect\hypertarget{prp:unnamed-chunk-25}{}{(\#prp:unnamed-chunk-25)
...
\BeginKnitrBlock{definition}\iffalse{-91-80-101-114-109-117-116-97-116-105-111-110-93-}\fi{}

\protect\hypertarget{def:unnamed-chunk-26}{}{(\#def:unnamed-chunk-26)
...
\BeginKnitrBlock{definition}\iffalse{-91-67-111-109-98-105-110-97-116-105-111-110-93-}\fi{}

\protect\hypertarget{def:unnamed-chunk-27}{}{(\#def:unnamed-chunk-27)
...
\BeginKnitrBlock{example}\iffalse{-91-70-108-105-112-112-105-110-103-32-67-111-105-110-115-93-}\fi{}

\protect\hypertarget{exm:flipcoins}{}{(\#exm:flipcoins)
...
\BeginKnitrBlock{example}\iffalse{-91-65-115-115-101-109-98-108-121-32-76-105-110-101-115-93-}\fi{}

\protect\hypertarget{exm:assembly}{}{(\#exm:assembly) \iffalse (Assembly
...
\BeginKnitrBlock{definition}\iffalse{-91-67-111-110-100-105-116-105-111-110-97-108-32-80-114-111-98-97-98-105-108-105-116-121-93-}\fi{}

\protect\hypertarget{def:condprob}{}{(\#def:condprob)
...
\BeginKnitrBlock{example}\iffalse{-91-66-97-108-97-110-99-101-100-32-100-105-101-93-}\fi{}

\protect\hypertarget{exm:unnamed-chunk-28}{}{(\#exm:unnamed-chunk-28)
...
\BeginKnitrBlock{example}\iffalse{-91-84-119-111-32-66-97-108-97-110-99-101-100-32-68-105-99-101-32-118-49-93-}\fi{}

\protect\hypertarget{exm:unnamed-chunk-29}{}{(\#exm:unnamed-chunk-29)
\iffalse (Two Balanced Dice v1) \fi{} }Toss two balanced dice. Let \(A\)
= \{sum of 5\} and \(B\) = \{first die is \(\leq\) 2\}. Find \(P(A|B)\)

\EndKnitrBlock{example}

\BeginKnitrBlock{example}\iffalse{-91-84-119-111-32-66-97-108-97-110-99-101-100-32-68-105-99-101-32-118-50-93-}\fi{}

\protect\hypertarget{exm:unnamed-chunk-30}{}{(\#exm:unnamed-chunk-30)
...
\BeginKnitrBlock{example}\iffalse{-91-85-110-98-97-108-97-110-99-101-100-32-68-105-101-93-}\fi{}

\protect\hypertarget{exm:unbalanced}{}{(\#exm:unbalanced)
...
\BeginKnitrBlock{example}\iffalse{-91-84-119-111-32-66-97-108-97-110-99-101-100-32-67-111-105-110-115-93-}\fi{}

\protect\hypertarget{exm:unnamed-chunk-31}{}{(\#exm:unnamed-chunk-31)
...
\BeginKnitrBlock{example}\iffalse{-91-84-119-111-32-67-97-114-100-115-93-}\fi{}

\protect\hypertarget{exm:unnamed-chunk-32}{}{(\#exm:unnamed-chunk-32)
...
\BeginKnitrBlock{example}\iffalse{-91-78-117-109-98-101-114-115-32-105-110-32-97-32-72-97-116-93-}\fi{}

\protect\hypertarget{exm:unnamed-chunk-33}{}{(\#exm:unnamed-chunk-33)
...
\BeginKnitrBlock{example}\iffalse{-91-79-110-101-32-67-97-114-100-93-}\fi{}

\protect\hypertarget{exm:unnamed-chunk-34}{}{(\#exm:unnamed-chunk-34)
...
\BeginKnitrBlock{definition}\iffalse{-91-77-117-108-116-105-112-108-105-99-97-116-105-118-101-32-82-117-108-101-93-}\fi{}

\protect\hypertarget{def:multformula}{}{(\#def:multformula)
...
\BeginKnitrBlock{example}\iffalse{-91-70-105-115-104-32-105-110-32-97-32-84-97-110-107-93-}\fi{}

\protect\hypertarget{exm:unnamed-chunk-35}{}{(\#exm:unnamed-chunk-35)
...
\BeginKnitrBlock{theorem}\iffalse{-91-76-97-119-32-111-102-32-84-111-116-97-108-32-80-114-111-98-97-98-105-108-105-116-121-93-}\fi{}

\protect\hypertarget{thm:totprob}{}{(\#thm:totprob) \iffalse (Law of
...
\BeginKnitrBlock{example}\iffalse{-91-76-111-110-103-32-72-97-105-114-93-}\fi{}

\protect\hypertarget{exm:unnamed-chunk-36}{}{(\#exm:unnamed-chunk-36)
...
\BeginKnitrBlock{theorem}\iffalse{-91-66-97-121-101-115-39-32-82-117-108-101-93-}\fi{}

\protect\hypertarget{thm:bayesdef}{}{(\#thm:bayesdef) \iffalse (Bayes'
...
\BeginKnitrBlock{example}\iffalse{-91-85-114-110-115-93-}\fi{}

\protect\hypertarget{exm:unnamed-chunk-37}{}{(\#exm:unnamed-chunk-37)
...
\BeginKnitrBlock{example}\iffalse{-91-76-97-114-103-101-32-66-114-105-100-103-101-115-93-}\fi{}

\protect\hypertarget{exm:unnamed-chunk-38}{}{(\#exm:unnamed-chunk-38)
...
\BeginKnitrBlock{definition}\iffalse{-91-73-110-100-101-112-101-110-116-32-69-118-101-110-116-115-93-}\fi{}

\protect\hypertarget{def:indep}{}{(\#def:indep) \iffalse (Indepent
...
\BeginKnitrBlock{example}\iffalse{-91-84-111-115-115-32-97-32-102-97-105-114-32-99-111-105-110-32-49-48-32-116-105-109-101-115-93-}\fi{}

\protect\hypertarget{exm:unnamed-chunk-39}{}{(\#exm:unnamed-chunk-39)
...
\BeginKnitrBlock{example}\iffalse{-91-85-110-98-97-108-97-110-99-101-32-68-105-101-32-82-101-118-105-115-105-116-101-100-93-}\fi{}

\protect\hypertarget{exm:unnamed-chunk-40}{}{(\#exm:unnamed-chunk-40)
...
\BeginKnitrBlock{example}\iffalse{-91-82-97-105-110-121-32-100-97-121-115-93-}\fi{}

\protect\hypertarget{exm:unnamed-chunk-42}{}{(\#exm:unnamed-chunk-42)
...
\BeginKnitrBlock{example}\iffalse{-91-70-111-111-116-98-97-108-32-77-97-116-99-104-93-}\fi{}

\protect\hypertarget{exm:unnamed-chunk-43}{}{(\#exm:unnamed-chunk-43)
...
\BeginKnitrBlock{example}\iffalse{-91-79-112-101-114-97-116-105-110-103-32-84-101-109-112-101-114-97-116-117-114-101-93-}\fi{}

\protect\hypertarget{exm:unnamed-chunk-45}{}{(\#exm:unnamed-chunk-45)
...
\BeginKnitrBlock{definition}\iffalse{-91-82-97-110-100-111-109-32-86-97-114-105-97-98-108-101-93-}\fi{}

\protect\hypertarget{def:rv}{}{(\#def:rv) \iffalse (Random Variable)
...
\BeginKnitrBlock{example}\iffalse{-91-67-111-105-110-32-84-111-115-115-93-}\fi{}

\protect\hypertarget{exm:unnamed-chunk-47}{}{(\#exm:unnamed-chunk-47)
...
\BeginKnitrBlock{example}\iffalse{-91-65-32-86-101-114-121-32-83-105-109-112-108-101-32-82-97-110-100-111-109-32-86-97-114-105-97-98-108-101-93-}\fi{}

\protect\hypertarget{exm:simple}{}{(\#exm:simple) \iffalse (A Very
...
\BeginKnitrBlock{example}\iffalse{-91-65-32-86-101-114-121-32-83-105-109-112-108-101-32-82-97-110-100-111-109-32-86-97-114-105-97-98-108-101-32-50-93-}\fi{}

\protect\hypertarget{exm:unnamed-chunk-48}{}{(\#exm:unnamed-chunk-48)
...
\BeginKnitrBlock{example}\iffalse{-91-65-32-86-101-114-121-32-83-105-109-112-108-101-32-82-97-110-100-111-109-32-86-97-114-105-97-98-108-101-32-51-93-}\fi{}

\protect\hypertarget{exm:unnamed-chunk-49}{}{(\#exm:unnamed-chunk-49)
...
\BeginKnitrBlock{example}\iffalse{-91-67-111-110-115-116-97-110-116-115-32-97-115-32-82-97-110-100-111-109-32-86-97-114-105-97-98-108-101-115-93-}\fi{}

\protect\hypertarget{exm:unnamed-chunk-50}{}{(\#exm:unnamed-chunk-50)
...
\BeginKnitrBlock{example}\iffalse{-91-73-110-100-105-99-97-116-111-114-32-70-117-110-99-116-105-111-110-115-93-}\fi{}

\protect\hypertarget{exm:unnamed-chunk-51}{}{(\#exm:unnamed-chunk-51)
...
\addcontentsline{toc}{chapter}{(PART) Part II}

\chapter{Methods}\label{methods}

\BeginKnitrBlock{example}\iffalse{-91-69-120-97-109-112-108-101-32-116-104-101-111-114-101-109-93-}\fi{}

\protect\hypertarget{exm:unnamed-chunk-53}{}{(\#exm:unnamed-chunk-53)
...
\protect\hypertarget{thm:pyth}{}{(\#thm:pyth) \iffalse (Pythagorean
...
\chapter*{(APPENDIX) R Tutorial}\label{appendix-r-tutorial}
\addcontentsline{toc}{chapter}{(APPENDIX) R Tutorial}
...
\CommentTok{# Loop: create a vector to store the results}
\CommentTok{# in}
...
\KeywordTok{vapply}\NormalTok{(women, fivenum, }\KeywordTok{c}\NormalTok{(}\DataTypeTok{Min. =} \DecValTok{0}\NormalTok{, }\StringTok{`}\DataTypeTok{1st Qu.}\StringTok{`}\NormalTok{ =}\StringTok{ }\DecValTok{0}\NormalTok{, }
    \DataTypeTok{Median =} \DecValTok{0}\NormalTok{, }\StringTok{`}\DataTypeTok{3rd Qu.}\StringTok{`}\NormalTok{ =}\StringTok{ }\DecValTok{0}\NormalTok{, }\DataTypeTok{Max. =} \DecValTok{0}\NormalTok{))}
\CommentTok{#>         height weight}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# the ouput of sapply is a vector the 's' in}
\CommentTok{# sapply stands for 'simplified' apply}
\NormalTok{mtcars}\OperatorTok{$}\NormalTok{gear2 <-}\StringTok{ }\KeywordTok{sapply}\NormalTok{(mtcars}\OperatorTok{$}\NormalTok{gear, }\ControlFlowTok{function}\NormalTok{(i) }\ControlFlowTok{if}\NormalTok{ (i }\OperatorTok{==}\StringTok{ }
\StringTok{    }\DecValTok{4}\NormalTok{) }\StringTok{"alot"} \ControlFlowTok{else} \StringTok{"some"}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{means <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{5}\NormalTok{, }\DecValTok{10}\NormalTok{, }\DecValTok{-3}\NormalTok{)}
\NormalTok{sds <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{5}\NormalTok{, }\DecValTok{10}\NormalTok{)}

\CommentTok{# MoreArgs is a list of arguments that dont}
\CommentTok{# change}
...
\NormalTok{randomNormals <-}\StringTok{ }\KeywordTok{mapply}\NormalTok{(rnorm, }\DataTypeTok{mean =}\NormalTok{ simParams}\OperatorTok{$}\NormalTok{means, }
    \DataTypeTok{sd =}\NormalTok{ simParams}\OperatorTok{$}\NormalTok{sds, }\DataTypeTok{MoreArgs =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{n =} \DecValTok{100}\NormalTok{))}
