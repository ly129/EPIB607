...
The version of the book you are reading now was built on 2018-10-12 and
was built on
...
top: Chapter 3 \citet{Yau}, bottom: Chapter 2 \citet{wilke}}\label{fig:unnamed-chunk-60}
\end{figure}
...
\citet{Yau}.}\label{fig:unnamed-chunk-61}
\end{figure}
...
position, shape, or color and vice versa \citep{wilke}.}\label{fig:unnamed-chunk-62}
\end{figure}
...
\begin{center}\includegraphics[width=\textwidth]{epib607_files/figure-latex/unnamed-chunk-63-1} \end{center}
...
\begin{center}\includegraphics[width=\textwidth]{epib607_files/figure-latex/unnamed-chunk-64-1} \end{center}
