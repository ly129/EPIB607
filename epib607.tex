...
The version of the book you are reading now was built on 2018-11-12 and
was built on
...
\begin{tabular}{l}
\hline
[1. Inference about a population mean (\$\textbackslash{}mu\$)](https://github.com/sahirbhatnagar/EPIB607/raw/master/slides/one\_sample\_mean/EPIB607\_one\_sample\_mean.pdf)\\
\hline
2. [P-values, Power and Sample Size](https://github.com/sahirbhatnagar/EPIB607/raw/master/slides/sample\_size/EPIB607\_sample\_size.pdf)\\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}{l}
\hline
1. [Epi Seminar (4-5 pm): Banning P-value use, or Misuse?](https://www.mcgill.ca/epi-biostat-occh/files/epi-biostat-occh/shernandez-diaz-announcement-15oct18.pdf?utm\_medium=email\&utm\_campaign=EBOH-e-News\&utm\_source=Envoke-All-contacts)\\
\hline
2. [P-values, Power and Sample Size](https://github.com/sahirbhatnagar/EPIB607/raw/master/slides/sample\_size/EPIB607\_sample\_size.pdf)\\
\hline
\end{tabular}
...
\begin{tabular}{l}
\hline
[1. DALITE Q6 due by 5 pm](https://github.com/sahirbhatnagar/EPIB607/raw/master/dalite/006\_proportions/006-proportions.pdf)\\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}{l}
\hline
[1. DALITE Q6 Solutions](https://github.com/sahirbhatnagar/EPIB607/raw/master/dalite/006\_proportions/006-proportions-sol.pdf)\\
\hline
2. [P-values, Power and Sample Size](https://github.com/sahirbhatnagar/EPIB607/raw/master/slides/sample\_size/EPIB607\_sample\_size.pdf)\\
\hline
3. [Inference about a population proportion](https://github.com/sahirbhatnagar/EPIB607/raw/master/slides/one\_sample\_prop/EPIB607\_one\_sample\_prop.pdf)\\
\hline
\end{tabular}
\end{table}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# upper limit --> lower tail needs 2.5%}
\NormalTok{manipulate}\OperatorTok{::}\KeywordTok{manipulate}\NormalTok{(}
\NormalTok{mosaic}\OperatorTok{::}\KeywordTok{xpbinom}\NormalTok{(}\DecValTok{4}\NormalTok{, }\DataTypeTok{size =} \DecValTok{5}\NormalTok{, }\DataTypeTok{prob =}\NormalTok{ proba),}
\DataTypeTok{proba =}\NormalTok{ manipulate}\OperatorTok{::}\KeywordTok{slider}\NormalTok{(}\FloatTok{0.001}\NormalTok{, }\FloatTok{0.999}\NormalTok{, }\DataTypeTok{step =} \FloatTok{0.001}\NormalTok{))}

\CommentTok{# lower limit --> upper tail needs 2.5%}
\CommentTok{# when lower.tail=FALSE, pbinom doesnt include k, i.e., P(Y > k)}
\NormalTok{manipulate}\OperatorTok{::}\KeywordTok{manipulate}\NormalTok{(}
\NormalTok{mosaic}\OperatorTok{::}\KeywordTok{xpbinom}\NormalTok{(}\DecValTok{3}\NormalTok{, }\DataTypeTok{size =} \DecValTok{5}\NormalTok{, }\DataTypeTok{prob =}\NormalTok{ proba, }\DataTypeTok{lower.tail =} \OtherTok{FALSE}\NormalTok{),}
\DataTypeTok{proba =}\NormalTok{ manipulate}\OperatorTok{::}\KeywordTok{slider}\NormalTok{(}\FloatTok{0.001}\NormalTok{, }\FloatTok{0.999}\NormalTok{, }\DataTypeTok{step =} \FloatTok{0.001}\NormalTok{))}


\CommentTok{# upper limit --> lower tail needs 2.5%}
\NormalTok{manipulate}\OperatorTok{::}\KeywordTok{manipulate}\NormalTok{(}
\NormalTok{mosaic}\OperatorTok{::}\KeywordTok{xpbinom}\NormalTok{(}\DecValTok{16}\NormalTok{, }\DataTypeTok{size =} \DecValTok{20}\NormalTok{, }\DataTypeTok{prob =}\NormalTok{ proba),}
\DataTypeTok{proba =}\NormalTok{ manipulate}\OperatorTok{::}\KeywordTok{slider}\NormalTok{(}\FloatTok{0.001}\NormalTok{, }\FloatTok{0.999}\NormalTok{, }\DataTypeTok{step =} \FloatTok{0.001}\NormalTok{))}


\CommentTok{# lower limit --> upper tail needs 2.5%}
\NormalTok{manipulate}\OperatorTok{::}\KeywordTok{manipulate}\NormalTok{(}
\NormalTok{mosaic}\OperatorTok{::}\KeywordTok{xpbinom}\NormalTok{(}\DecValTok{15}\NormalTok{, }\DataTypeTok{size =} \DecValTok{20}\NormalTok{, }\DataTypeTok{prob =}\NormalTok{ proba, }\DataTypeTok{lower.tail =} \OtherTok{FALSE}\NormalTok{),}
\DataTypeTok{proba =}\NormalTok{ manipulate}\OperatorTok{::}\KeywordTok{slider}\NormalTok{(}\FloatTok{0.001}\NormalTok{, }\FloatTok{0.999}\NormalTok{, }\DataTypeTok{step =} \FloatTok{0.001}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{tabular}{l}
\hline
1. [Inference about a population proportion](https://github.com/sahirbhatnagar/EPIB607/raw/master/slides/one\_sample\_prop/EPIB607\_one\_sample\_prop.pdf)\\
\hline
2. [Inference about a population rate](https://github.com/sahirbhatnagar/EPIB607/raw/master/slides/one\_sample\_rate/EPIB607\_one\_sample\_rate\_JH.pdf)\\
\hline
\end{tabular}
\end{table}

\subsubsection{Code for Poisson Confidence
Intervals}\label{code-for-poisson-confidence-intervals}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# upper limit --> lower tail needs 2.5%}
\NormalTok{manipulate}\OperatorTok{::}\KeywordTok{manipulate}\NormalTok{(}
\NormalTok{mosaic}\OperatorTok{::}\KeywordTok{xppois}\NormalTok{(}\DecValTok{6}\NormalTok{, }\DataTypeTok{lambda =}\NormalTok{ LAMBDA), }
\DataTypeTok{LAMBDA =}\NormalTok{ manipulate}\OperatorTok{::}\KeywordTok{slider}\NormalTok{(}\FloatTok{0.01}\NormalTok{, }\DecValTok{20}\NormalTok{, }\DataTypeTok{step =} \FloatTok{0.01}\NormalTok{))}


\CommentTok{# lower limit --> upper tail needs 2.5%}
\CommentTok{# when lower.tail=FALSE, ppois doesnt include k, i.e., P(Y > k)}
\NormalTok{manipulate}\OperatorTok{::}\KeywordTok{manipulate}\NormalTok{(}
\NormalTok{mosaic}\OperatorTok{::}\KeywordTok{xppois}\NormalTok{(}\DecValTok{5}\NormalTok{, }\DataTypeTok{lambda =}\NormalTok{ LAMBDA, }\DataTypeTok{lower.tail =} \OtherTok{FALSE}\NormalTok{),}
\DataTypeTok{LAMBDA =}\NormalTok{ manipulate}\OperatorTok{::}\KeywordTok{slider}\NormalTok{(}\FloatTok{0.01}\NormalTok{, }\DecValTok{20}\NormalTok{, }\DataTypeTok{step =} \FloatTok{0.01}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{tabular}{l}
\hline
1. Final exam date: December 6th, Otto MAASS 112 (cap 220) available from 9am-6pm\\
\hline
2. [Midterm Review](https://github.com/sahirbhatnagar/EPIB607/raw/master/slides/midterm\_review/EPIB607\_midterm\_review.pdf)\\
\hline
3. [Inference about a population rate](https://github.com/sahirbhatnagar/EPIB607/raw/master/slides/one\_sample\_rate/EPIB607\_one\_sample\_rate\_JH.pdf)\\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}{l}
\hline
1. [Muddiest Point in the Lecture (Muddy Cards)](http://www.cdio.org/files/mudcards.pdf)\\
\hline
2. [Inference about a population rate](https://github.com/sahirbhatnagar/EPIB607/raw/master/slides/one\_sample\_rate/EPIB607\_one\_sample\_rate\_JH.pdf)\\
\hline
\end{tabular}
...
\begin{tabular}{l}
\hline
[1. Muddy cards for Rates](https://github.com/sahirbhatnagar/EPIB607/raw/master/QNA/EPIB607\_Rates\_QNA.pdf)\\
\hline
[2. Regression handout](https://www.dropbox.com/s/qpm7ebzgq4e619b/regression\_handout.pdf?dl=0)\\
\hline
[3. Parameter Contrasts with Regression](https://github.com/sahirbhatnagar/EPIB607/raw/master/slides/regression/EPIB607\_regression\_handout.pdf)\\
\hline
\end{tabular}
\end{table}

\subsubsection{Fitting a regression model for Parameter
Contrasts}\label{fitting-a-regression-model-for-parameter-contrasts}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# load function to get depths}
\KeywordTok{source}\NormalTok{(}\StringTok{"https://github.com/sahirbhatnagar/EPIB607/raw/master/exercises/water/automate_water_task.R"}\NormalTok{)}

\CommentTok{# get 1000 depths}
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{222333444}\NormalTok{)}
\NormalTok{depths <-}\StringTok{ }\KeywordTok{automate_water_task}\NormalTok{(}\DataTypeTok{index =} \KeywordTok{sample}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{50000}\NormalTok{, }\DecValTok{1000}\NormalTok{), }
                              \DataTypeTok{student_id =} \DecValTok{222333444}\NormalTok{, }\DataTypeTok{type =} \StringTok{"depth"}\NormalTok{)}

\CommentTok{# separate by north and south hemisphere}
\NormalTok{depths_north <-}\StringTok{ }\NormalTok{depths[}\KeywordTok{which}\NormalTok{(depths}\OperatorTok{$}\NormalTok{lat}\OperatorTok{>}\DecValTok{0}\NormalTok{),]}
\NormalTok{depths_south <-}\StringTok{ }\NormalTok{depths[}\KeywordTok{which}\NormalTok{(depths}\OperatorTok{$}\NormalTok{lat}\OperatorTok{<}\DecValTok{0}\NormalTok{),]}

\CommentTok{# restrict sample to 200 (at random)}
\NormalTok{depths_north <-}\StringTok{ }\NormalTok{depths_north[}\KeywordTok{sample}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\KeywordTok{nrow}\NormalTok{(depths_north), }\DecValTok{200}\NormalTok{), ]}
\NormalTok{depths_south <-}\StringTok{ }\NormalTok{depths_south[}\KeywordTok{sample}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\KeywordTok{nrow}\NormalTok{(depths_south), }\DecValTok{200}\NormalTok{), ]}

\CommentTok{# add indicator variable}
\NormalTok{depths_north}\OperatorTok{$}\NormalTok{South <-}\StringTok{ }\DecValTok{0}
\NormalTok{depths_south}\OperatorTok{$}\NormalTok{South <-}\StringTok{ }\DecValTok{1}

\CommentTok{# combine data}
\NormalTok{depths <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(depths_north, depths_south)}
\KeywordTok{head}\NormalTok{(depths)}

\CommentTok{# calculate mean and sd by hemisphere}
\NormalTok{means <-}\StringTok{ }\KeywordTok{aggregate}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ depths, }\DataTypeTok{by =} \KeywordTok{list}\NormalTok{(depths}\OperatorTok{$}\NormalTok{South), }\DataTypeTok{FUN =} \StringTok{"mean"}\NormalTok{)}\OperatorTok{$}\NormalTok{alt}
\NormalTok{sds <-}\StringTok{ }\KeywordTok{aggregate}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ depths, }\DataTypeTok{by =} \KeywordTok{list}\NormalTok{(depths}\OperatorTok{$}\NormalTok{South), }\DataTypeTok{FUN =} \StringTok{"sd"}\NormalTok{)}\OperatorTok{$}\NormalTok{alt}

\CommentTok{# create boxplot and annotate plot}
\KeywordTok{boxplot}\NormalTok{(alt }\OperatorTok{~}\StringTok{ }\NormalTok{South, }\DataTypeTok{data =}\NormalTok{ depths,}
        \DataTypeTok{ylab=}\StringTok{"Ocean Depth (metres)"}\NormalTok{,}
        \DataTypeTok{xlab=}\StringTok{"NORTH                                                                       SOUTH"}\NormalTok{,}
        \DataTypeTok{pch=}\DecValTok{19}\NormalTok{,}\DataTypeTok{cex=}\FloatTok{0.25}\NormalTok{)}
\KeywordTok{points}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{), means, }\DataTypeTok{pch=}\DecValTok{19}\NormalTok{)}
\KeywordTok{text}\NormalTok{(}\FloatTok{0.9}\NormalTok{, means[}\DecValTok{1}\NormalTok{],}
     \KeywordTok{expression}\NormalTok{(}\KeywordTok{widehat}\NormalTok{(y[}\DecValTok{0}\NormalTok{])) )}
\KeywordTok{text}\NormalTok{(}\FloatTok{2.1}\NormalTok{, means[}\DecValTok{2}\NormalTok{],}
     \KeywordTok{expression}\NormalTok{(}\KeywordTok{widehat}\NormalTok{(y[}\DecValTok{1}\NormalTok{])) )}
\KeywordTok{segments}\NormalTok{(}\DecValTok{1}\NormalTok{,means[}\DecValTok{1}\NormalTok{],}\DecValTok{2}\NormalTok{,means[}\DecValTok{1}\NormalTok{],}
         \DataTypeTok{lty=}\StringTok{"dotted"}\NormalTok{)}
\KeywordTok{segments}\NormalTok{(}\DecValTok{1}\NormalTok{,means[}\DecValTok{1}\NormalTok{],}\DecValTok{2}\NormalTok{,means[}\DecValTok{2}\NormalTok{],}
         \DataTypeTok{lty=}\StringTok{"dotted"}\NormalTok{)}
\KeywordTok{segments}\NormalTok{(}\FloatTok{2.2}\NormalTok{,means[}\DecValTok{1}\NormalTok{],}\FloatTok{2.45}\NormalTok{,means[}\DecValTok{1}\NormalTok{],}
         \DataTypeTok{lty=}\StringTok{"dotted"}\NormalTok{)}
\KeywordTok{segments}\NormalTok{(}\FloatTok{2.2}\NormalTok{,means[}\DecValTok{2}\NormalTok{],}\FloatTok{2.45}\NormalTok{,means[}\DecValTok{2}\NormalTok{],}
         \DataTypeTok{lty=}\StringTok{"dotted"}\NormalTok{)}
\KeywordTok{text}\NormalTok{((}\FloatTok{2.2}\OperatorTok{+}\FloatTok{2.45}\NormalTok{)}\OperatorTok{/}\DecValTok{2}\NormalTok{,means[}\DecValTok{2}\NormalTok{],}
     \KeywordTok{sprintf}\NormalTok{(}\StringTok{"+ %0.2f m"}\NormalTok{, means[}\DecValTok{2}\NormalTok{]}\OperatorTok{-}\NormalTok{means[}\DecValTok{1}\NormalTok{]), }\DataTypeTok{adj=}\KeywordTok{c}\NormalTok{(}\FloatTok{0.5}\NormalTok{,}\OperatorTok{-}\FloatTok{0.25}\NormalTok{),}\DataTypeTok{cex=}\FloatTok{0.75}\NormalTok{)}
\KeywordTok{text}\NormalTok{(}\FloatTok{2.5}\NormalTok{,means[}\DecValTok{1}\NormalTok{],}
     \KeywordTok{expression}\NormalTok{(}\KeywordTok{hat}\NormalTok{(Delta)),}\DataTypeTok{adj=}\KeywordTok{c}\NormalTok{(}\FloatTok{0.5}\NormalTok{,}\DecValTok{0}\NormalTok{)) }
\KeywordTok{arrows}\NormalTok{(}\FloatTok{0.8}\NormalTok{,means[}\DecValTok{1}\NormalTok{],}\FloatTok{0.43}\NormalTok{,means[}\DecValTok{1}\NormalTok{],}
       \DataTypeTok{length=}\FloatTok{0.05}\NormalTok{,}\DataTypeTok{angle=}\DecValTok{20}\NormalTok{)}
\KeywordTok{arrows}\NormalTok{(}\FloatTok{0.8}\NormalTok{,means[}\DecValTok{2}\NormalTok{],}\FloatTok{0.43}\NormalTok{,means[}\DecValTok{2}\NormalTok{],}
       \DataTypeTok{length=}\FloatTok{0.05}\NormalTok{,}\DataTypeTok{angle=}\DecValTok{20}\NormalTok{)}


\CommentTok{# inference}
\NormalTok{n0 <-}\StringTok{ }\KeywordTok{nrow}\NormalTok{(depths_north)}
\NormalTok{n1 <-}\StringTok{ }\KeywordTok{nrow}\NormalTok{(depths_south)}

\NormalTok{mean0 <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(depths_north}\OperatorTok{$}\NormalTok{alt)}
\NormalTok{mean1 <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(depths_south}\OperatorTok{$}\NormalTok{alt)}

\NormalTok{var0 <-}\StringTok{ }\KeywordTok{var}\NormalTok{(depths_north}\OperatorTok{$}\NormalTok{alt)}
\NormalTok{var1 <-}\StringTok{ }\KeywordTok{var}\NormalTok{(depths_south}\OperatorTok{$}\NormalTok{alt)}

\NormalTok{SEM <-}\StringTok{ }\KeywordTok{sqrt}\NormalTok{(var0}\OperatorTok{/}\NormalTok{n0 }\OperatorTok{+}\StringTok{ }\NormalTok{var1}\OperatorTok{/}\NormalTok{n1)}

\NormalTok{test_statistic <-}\StringTok{ }\NormalTok{(mean0 }\OperatorTok{-}\StringTok{ }\NormalTok{mean1) }\OperatorTok{/}\StringTok{ }\NormalTok{SEM}

\CommentTok{# t.test}
\CommentTok{# unequal variances}
\KeywordTok{t.test}\NormalTok{(alt }\OperatorTok{~}\StringTok{ }\NormalTok{South, }\DataTypeTok{data =}\NormalTok{ depths, }\DataTypeTok{var.equal =} \OtherTok{FALSE}\NormalTok{) }\CommentTok{# default}
\NormalTok{(mean0 }\OperatorTok{-}\StringTok{ }\NormalTok{mean1) }\OperatorTok{+}\StringTok{ }\KeywordTok{qt}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\FloatTok{0.025}\NormalTok{, }\FloatTok{0.975}\NormalTok{), }\DataTypeTok{df =} \FloatTok{349.61783}\NormalTok{) }\OperatorTok{*}\StringTok{ }\NormalTok{SEM}
\KeywordTok{qnorm}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\FloatTok{0.025}\NormalTok{, }\FloatTok{0.975}\NormalTok{), }\DataTypeTok{mean =}\NormalTok{ mean0 }\OperatorTok{-}\StringTok{ }\NormalTok{mean1, }\DataTypeTok{sd =}\NormalTok{ SEM)}

\CommentTok{# equal variances}
\KeywordTok{t.test}\NormalTok{(alt }\OperatorTok{~}\StringTok{ }\NormalTok{South, }\DataTypeTok{data =}\NormalTok{ depths, }\DataTypeTok{var.equal =} \OtherTok{TRUE}\NormalTok{)}
\NormalTok{(mean0 }\OperatorTok{-}\StringTok{ }\NormalTok{mean1) }\OperatorTok{+}\StringTok{ }\KeywordTok{qt}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\FloatTok{0.025}\NormalTok{, }\FloatTok{0.975}\NormalTok{), }\DataTypeTok{df =}\NormalTok{ n0 }\OperatorTok{+}\StringTok{ }\NormalTok{n1 }\OperatorTok{-}\StringTok{ }\DecValTok{2}\NormalTok{) }\OperatorTok{*}\StringTok{ }\NormalTok{SEM}
\KeywordTok{qnorm}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\FloatTok{0.025}\NormalTok{, }\FloatTok{0.975}\NormalTok{), }\DataTypeTok{mean =}\NormalTok{ mean0 }\OperatorTok{-}\StringTok{ }\NormalTok{mean1, }\DataTypeTok{sd =}\NormalTok{ SEM)}


\CommentTok{# regression}
\NormalTok{fit <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(alt }\OperatorTok{~}\StringTok{ }\NormalTok{South, }\DataTypeTok{data =}\NormalTok{ depths)}
\KeywordTok{summary}\NormalTok{(fit)}

\CommentTok{# lm assumes equal variances}
\NormalTok{(mean1 }\OperatorTok{-}\StringTok{ }\NormalTok{mean0) }\OperatorTok{+}\StringTok{ }\KeywordTok{qt}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\FloatTok{0.025}\NormalTok{, }\FloatTok{0.975}\NormalTok{), }\DataTypeTok{df =}\NormalTok{ n0 }\OperatorTok{+}\StringTok{ }\NormalTok{n1 }\OperatorTok{-}\StringTok{ }\DecValTok{2}\NormalTok{) }\OperatorTok{*}\StringTok{ }\NormalTok{SEM}
\end{Highlighting}
\end{Shaded}
...
\begin{tabular}{l}
\hline
[1. DALITE Q7 Solutions](https://github.com/sahirbhatnagar/EPIB607/raw/master/dalite/007\_two\_sample/007-two-sample-sol.pdf)\\
\hline
[2. Regression handout 002](https://github.com/sahirbhatnagar/EPIB607/raw/master/slides/regression/handouts/EPIB607\_handout\_002.pdf)\\
\hline
[3. Parameter Contrasts with Regression](https://github.com/sahirbhatnagar/EPIB607/raw/master/slides/regression/EPIB607\_regression\_handout.pdf)\\
\hline
\end{tabular}
...
\begin{tabular}{l}
\hline
[1. Regression handout 002](https://github.com/sahirbhatnagar/EPIB607/raw/master/slides/regression/handouts/EPIB607\_handout\_002.pdf)\\
\hline
[2. Regression handout 003](https://github.com/sahirbhatnagar/EPIB607/raw/master/slides/regression/handouts/EPIB607\_handout\_003.pdf)\\
\hline
\end{tabular}
\end{table}
...
\subsection{Friday November 30}\label{friday-november-30}
...
\subsection{Thursday December 6}\label{thursday-december-6}
...
\item
  \href{https://github.com/sahirbhatnagar/EPIB607/raw/master/slides/one_sample_rate/EPIB607_one_sample_rate_JH.pdf}{Inference
  about a population rate}
\item
  \href{https://github.com/sahirbhatnagar/EPIB607/raw/master/slides/midterm_review/EPIB607_midterm_review.pdf}{Midterm
  Review}
\item
  \href{https://github.com/sahirbhatnagar/EPIB607/raw/master/slides/regression/EPIB607_regression_handout.pdf}{Regression}
\end{enumerate}
...
\addlinespace
6 & [Power, Sample Size and Inference for a Population Proportion](https://github.com/sahirbhatnagar/EPIB607/raw/master/assignments/a6/a6\_power\_proportions.pdf) & [a6\_template.Rmd](https://github.com/sahirbhatnagar/EPIB607/raw/master/assignments/a6/a6\_template.Rmd) &  & October 26, 2018\\
7 & [Inference for one sample rate](https://github.com/sahirbhatnagar/EPIB607/raw/master/assignments/a7/a7\_rates.pdf) & [a7\_template.Rmd](https://github.com/sahirbhatnagar/EPIB607/raw/master/assignments/a7/a7\_template.Rmd) &  & November 9, 2018\\
8 & [Two-Sample Mean](https://github.com/sahirbhatnagar/EPIB607/raw/master/assignments/a8/a8\_two\_sample\_mean.pdf) &  &  & November 16, 2018\\
9 & Regression &  &  & November 23, 2018\\
10 & Nonparametric Statistics &  &  & November 30, 2018\\
\bottomrule
\end{tabular}
...
\item
  ...
  (due October 17, 2018)} --
  \href{https://github.com/sahirbhatnagar/EPIB607/raw/master/dalite/006_proportions/006-proportions-sol.pdf}{Solutions}
\item
  \href{https://github.com/sahirbhatnagar/EPIB607/raw/master/dalite/007_two_sample/007-two-sample.pdf}{Q7
  (due November 7, 2018)} --
  \href{https://github.com/sahirbhatnagar/EPIB607/raw/master/dalite/007_two_sample/007-two-sample-sol.pdf}{Solutions}
\end{enumerate}
...
top: Chapter 3 \citet{Yau}, bottom: Chapter 2 \citet{wilke}}\label{fig:unnamed-chunk-66}
\end{figure}
...
\citet{Yau}.}\label{fig:unnamed-chunk-67}
\end{figure}
...
position, shape, or color and vice versa \citep{wilke}.}\label{fig:unnamed-chunk-68}
\end{figure}
...
\begin{center}\includegraphics[width=\textwidth]{epib607_files/figure-latex/unnamed-chunk-69-1} \end{center}
...
\begin{center}\includegraphics[width=\textwidth]{epib607_files/figure-latex/unnamed-chunk-70-1} \end{center}
...
\begin{center}\includegraphics[width=\textwidth]{epib607_files/figure-latex/unnamed-chunk-71-1} \end{center}
