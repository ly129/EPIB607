...
\begin{tabular}{l}
\hline
[1. Regression handout](https://www.dropbox.com/s/qpm7ebzgq4e619b/regression\_handout.pdf?dl=0)\\
\hline
\end{tabular}
\end{table}
...
top: Chapter 3 \citet{Yau}, bottom: Chapter 2 \citet{wilke}}\label{fig:unnamed-chunk-65}
\end{figure}
...
\citet{Yau}.}\label{fig:unnamed-chunk-66}
\end{figure}
...
position, shape, or color and vice versa \citep{wilke}.}\label{fig:unnamed-chunk-67}
\end{figure}
...
\begin{center}\includegraphics[width=\textwidth]{epib607_files/figure-latex/unnamed-chunk-68-1} \end{center}
