...
\frame{\frametitle{The binomial distribution} Let $Y$ be the number
	of daughters a woman will have, $n$ the number of children
...
\frame{\frametitle{The binomial distribution} The binomial
	distribution has the following four assumptions:
	\begin{enumerate}
		\item There are $n$ trials.
		\item Each trial has two possible outcomes, ``success'' or
		``failure.'' (Usually, when coding the outcomes, we take 1 to be the
		success outcome.)
		\item The probability of success, $p$, is the same
		for each trial.
...
{\centering \includegraphics[width=1\linewidth]{figure/unnamed-chunk-22-1} 
...
{\centering \includegraphics[width=1\linewidth]{figure/unnamed-chunk-30-1} 
...
{\centering \includegraphics[width=1\linewidth]{figure/unnamed-chunk-37-1} 
