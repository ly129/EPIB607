...
\includegraphics[angle=90, scale=0.25]{type1.pdf}
	...
	\begin{itemize}
		...
		reject $H_0$ when in fact $H_0$ is true.
...
\small
\begin{itemize}
	\item the blue area represents the Type I error -- the probability of
	rejecting $H_0$ \textbf{if $H_0$ is true}.
	\item the purple area represents the Type II error -- the probability of
