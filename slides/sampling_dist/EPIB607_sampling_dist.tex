...
\title{Sampling Distributions, the Central Limit Theorem (CLT) and Confidence Intervals}
...
\frame{\frametitle{Example: Inference for a single population mean} We begin
	...
	\begin{itemize}
		...
		\item We can use `mosaic::xpnorm(q = c(-1.96, 1.96))` to find that there is a 95\% chance that a $\mathcal{N}$(0,1) random variable lies within 1.96 
...
[25] pacman_0.4.6     purrr_0.2.5      magrittr_1.5     backports_1.1.2 
[29] splines_3.5.1    scales_1.0.0     MASS_7.3-50      assertthat_0.2.0
[33] colorspace_1.4-0 stringi_1.2.4    lazyeval_0.2.1   munsell_0.5.0   
