...
<<fig.align='center',out.width='.6\\linewidth',echo=FALSE,cache=TRUE>>=
library(ggplot2)
...
<<fig.align='center',out.width='.6\\linewidth',echo=FALSE,warning=FALSE,message=FALSE,cache=TRUE>>=
set.seed(12893)
...
<<fig.align='center',out.width='.6\\linewidth', echo=FALSE>>=
curve(dnorm(x), -4,4, lty=1, ylab="density", col=1, lwd=2)
curve(dt(x,15), -4,4, add=TRUE, lty=2, col=2,lwd=2)
...
3 & \Sexpr{qt(0.975,3)}\\
5 & \Sexpr{qt(0.975,5)}\\
30 & \Sexpr{qt(0.975,30)}\\
50 & \Sexpr{qt(0.975,50)}\\
100 & \Sexpr{qt(0.975,100)}\\
250 & \Sexpr{qt(0.975,250)}\\
500 & \Sexpr{qt(0.975,500)}
\end{tabular}
\end{center}
