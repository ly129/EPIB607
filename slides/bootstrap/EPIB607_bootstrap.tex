...
\caption[The original data distribution of sampled depths of the ocean]{The original data distribution of sampled depths of the ocean. Note that it is bimodal and not Normal looking.}\label{fig:unnamed-chunk-1}
\end{figure}
...
\caption[The sampling distribution for the mean depth of the ocean with samples of size $n=16$, looks normal (centered at $\mu=37$ and SD equal to $\sigma/\sqrt{16}$) ]{The sampling distribution for the mean depth of the ocean with samples of size $n=16$, looks normal (centered at $\mu=37$ and SD equal to $\sigma/\sqrt{16}$) }\label{fig:unnamed-chunk-2}
\end{figure}
...
\caption{68\% Confidence interval calculated using  \mbox{\texttt{qnorm(p = c(0.16,0.84), 37, 4.2)}}}\label{fig:unnamed-chunk-3}
\end{figure}
...
\caption{95\% Confidence interval calculated using  \mbox{\texttt{qnorm(p = c(0.025,0.975), 37, 4.2)}}}\label{fig:unnamed-chunk-4}
\end{figure}
...
other attached packages:
 [1] bindrcpp_0.2.2     tidyr_0.8.1        mosaic_1.4.0      
 [4] Matrix_1.2-14      mosaicData_0.17.0  ggformula_0.9.0   
 [7] ggstance_0.3.1     ggplot2_3.0.0.9000 lattice_0.20-35   
[10] dplyr_0.7.6        knitr_1.20        

loaded via a namespace (and not attached):
 [1] Rcpp_0.12.18       RColorBrewer_1.1-2 pillar_1.3.0      
 [4] compiler_3.5.1     highr_0.7          plyr_1.8.4        
 [7] bindr_0.1.1        tools_3.5.1        digest_0.6.16     
[10] nlme_3.1-137       evaluate_0.11      tibble_1.4.2      
[13] gtable_0.2.0       pkgconfig_2.0.2    rlang_0.2.2       
[16] ggrepel_0.8.0      ggdendro_0.1-20    gridExtra_2.3     
[19] withr_2.1.2        stringr_1.3.1      grid_3.5.1        
[22] tidyselect_0.2.4   mosaicCore_0.6.0   glue_1.3.0        
[25] R6_2.2.2           pacman_0.4.6       purrr_0.2.5       
[28] magrittr_1.5       codetools_0.2-15   backports_1.1.2   
[31] splines_3.5.1      scales_1.0.0       MASS_7.3-50       
[34] assertthat_0.2.0   colorspace_1.4-0   stringi_1.2.4     
[37] lazyeval_0.2.1     munsell_0.5.0      broom_0.5.0       
[40] crayon_1.3.4       Cairo_1.5-9       
\end{verbatim}
