...
```{r, results='asis', echo=FALSE, eval=TRUE}
df <- as.data.frame(rbind(
c("1. Boxplots and Standard Deviation"),
c("2. Parameters and Statistics"),
c("3. Sampling Distributions and Central Limit Theorem")
))
...
knitr::kable(as.data.frame(rbind(
  ...
  c("3","Sampling Distributions and Central Limit Theorem","","","September 28, 2018"),
...
2. [Q2 (due September 19, 2018)](https://github.com/sahirbhatnagar/EPIB607/raw/master/dalite/002_box_sd_curves/002-box-sd-curves.pdf)
