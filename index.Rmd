...
knitr::kable(data.frame(c("Assignments","DALITE Quizzes","Midterm","Project","Final Exam"),
                        c("30%","10%","20%","10%","30%")), col.names = c("",""),
             booktabs = TRUE)
```
...
knitr::kable(as.data.frame(rbind(
  ...
  col.names = c("Date","Video","Readings","Exercise","DALITE"),
  booktabs = TRUE)
```
...
1. [A1 (due September 20, 2018)](https://github.com/sahirbhatnagar/EPIB607/raw/master/assignments/a1/a1-setup.pdf)
