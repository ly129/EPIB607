...
weight <- read.csv("~/git_repositories/epib607/assignments/a5/weight_gain.csv")
knitr::kable(weight)
```


a. Calculate a 95% confidence interval for the mean weight change and give a sentence explaining the meaning of the 95%.
b. Calculate a 95% bootstrap confidence interval for the mean weight change and compare to the one obtained in a.
c. Convert the units of the mean weight gain and 95% confidence interval to pounds. Note that 1 kilogram is equal to 2.2 pounds. 
d. Test the null hypothesis that the mean weight gain is 16 lbs. State your assumptions and justify your choice of test. Be sure to specify the null and alternative hypotheses. What do you conclude?
