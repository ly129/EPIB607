...
b) If the mean steps counted by the step counter was 470 steps (ie: $\mu_a = 470$), the probability of getting a sample of 25 with a mean less than the critical value of `r step_critvdisp` steps is `r step_prob`. This is the statistical power to detect 470 or fewer steps. 
