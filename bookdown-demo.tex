...
\section{Professor information}\label{professor-information}
...
\item
  ...
  \textbackslash{}
\item
  Website: \url{http://sahirbhatnagar.com/MATH697/} \textbackslash{}
  \textbf{Lectures:}\& Tuesdays 9am - 12pm \textbackslash{}
  \%\textbf{Office:} \& TBD \textbackslash{} \textbf{Office Hours:}\& By
  appointment only \textbackslash{} \%\textbf{Phone:} \& (123) 867-5309
  \textbackslash{} \textbf {Prerequisite(s):} \& None\textbackslash{}
  \textbf {Text(s):} \&
  \emph{Modern Mathematical Statistics with Applications},
  2\textsuperscript{nd} Edition \textbackslash{} \& by Jay L. Devore and
  Kenneth N. Berk \textbackslash{}end\{tabular\}
\end{itemize}
